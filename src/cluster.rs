...
impl<'a> Cluster<'a> {
    pub fn new(matches: &'a ArgMatches) -> Self {
        ...
        Cluster {
            ...
            encrypted_ca_key_path: format!("clusters/{}/ca-key.pem.encrypted", name),
            encrypted_master_key_path: format!("clusters/{}/apiserver-key.pem.encrypted", name),
            encrypted_node_key_path: format!("clusters/{}/node-key.pem.encrypted", name),
            name: name,
